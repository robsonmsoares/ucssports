...
<head>
    ...
    <title>UCS Sports | Cadastrar</title>
...
<div class="register-box">
    <div class="register-logo">
        <a href="{{ url('/home') }}"><b>UCS Sports</b></a>
    </div>
    ...
    <div class="register-box-body">
        ...
        <form method="post" action="{{ url('/register') }}">
            ...
            <div class="form-group has-feedback{{ $errors->has('cpfCnpj') ? ' has-error' : '' }}">
                <input type="text" class="form-control" name="cpfCnpj" value="{{ old('cpfCnpj') }}" placeholder="CPF/CNPJ">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
            ...
            <div class="form-group has-feedback{{ $errors->has('dataNascimento') ? ' has-error' : '' }}">
                <input type="text" class="form-control" name="dataNascimento" value="{{ old('dataNascimento') }}" placeholder="Data de nascimento">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
            ...
            <div class="form-group has-feedback{{ $errors->has('timeCoracaoId') ? ' has-error' : '' }}">
                <input type="text" class="form-control" name="timeCoracaoId" value="{{ old('timeCoracaoId') }}" placeholder="Time do coração">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>

                @if ($errors->has('timeCoracaoId'))
                    <span class="help-block">
                        <strong>{{ $errors->first('timeCoracaoId') }}</strong>
                    </span>
                @endif
            </div>
