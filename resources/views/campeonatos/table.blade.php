            ...
            <td>{{ $campeonatos->dataInicio }}</td>
                <td>
                    ...
                    <div class='btn-group'>
                        ...
                        <a href="{{ route('campeonatos.edit', [$campeonatos->campId]) }}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
                        <a href="{{ route('campeonatos.create', [$campeonatos->campId]) }}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon glyphicon-wrench"></i></a>
                        <a href="{{ route('campeonatos.create', [$campeonatos->campId]) }}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon glyphicon-list-alt"></i></a>
